...
export const TYPE_TO_DOMAIN: Record<string, string> = {
  ...
  EMETTEUR: "CHAUFFAGE",
  // Référentiel MyXploit App (fiche équipement) — un type par matériel
  POMPE_CHARGE: "CHAUFFAGE",
  VANNE_2V_MOTORISEE: "CHAUFFAGE",
  POT_A_BOUES: "TRAITEMENT_EAU",
  GROUPE_MAINTIEN_PRESSION: "CHAUFFAGE",
  COMPTEUR_EAU_APPOINT: "COMPTAGE",
  POMPE_DOSEUSE: "TRAITEMENT_EAU",
  POMPE: "CHAUFFAGE",
  POMPE_DOUBLE: "CHAUFFAGE",
  VANNE_3V: "CHAUFFAGE",
  BOUTEILLE_DECOUPLAGE: "CHAUFFAGE",
  VENTILO_CONVECTEUR: "CLIMATISATION",
  AEROTHERME: "CHAUFFAGE",
  RIDEAU_AIR_CHAUD: "CHAUFFAGE",
  SONDE: "CHAUFFAGE",
  VARIATEUR: "CHAUFFAGE",
  // Autre
  AUTRE: "AUTRE",
