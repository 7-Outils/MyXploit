...
import { StationMapLeaflet } from "@/components/outils/StationMapLeaflet";
...
export function DjuTool({ mapVariant }: { mapVariant: "svg" | "leaflet" }) {
  const { data: stationsData } = useSWR<{ stations: StationOption[] }>(
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="ml-auto text-[11px] font-medium uppercase tracking-wide px-2 py-1 rounded-md bg-gray-100 text-text-secondary">
          Carte : {mapVariant === "svg" ? "SVG maison" : "Leaflet"}
        </span>
      </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-text-muted mt-1">
                {mapVariant === "svg"
                  ...
                  : "Zoomez (molette) et cliquez une station — idéal pour la région parisienne"}
              </p>
            </div>
          ) : (
