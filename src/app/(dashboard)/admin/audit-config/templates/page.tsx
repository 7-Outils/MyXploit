      ...
      {templates.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-100 p-8 text-center">
          ...
          <p className="text-gray-500 mt-2">
            Créez vos propres templates de checklist pour vos audits techniques.
          </p>
          <Link
            href="/admin/audit-config/templates/new"
            className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-colors"
          >
            <Plus size={18} />
            Créer un template
          </Link>
